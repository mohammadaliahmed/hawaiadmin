...
import com.appsinventiv.hawaiadmin.Utils.CompressImage;
import com.appsinventiv.hawaiadmin.Utils.Glide4Engine;
...
public class Profile extends AppCompatActivity {
    ...
    private void getDataFromServer() {
        ...
        mDatabase.child("Admins").child(SharedPrefs.getUserModel().getPhone()).addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void signup() {
        if (mSelected.size() == 0) {
            ...
            mDatabase.child("Admins").child(SharedPrefs.getUserModel().getPhone()).updateChildren(map).addOnSuccessListener(new OnSuccessListener<Void>() {
                @Override
