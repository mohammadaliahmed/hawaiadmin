package com.hawai.hawaiadmin.Utils;
...
//
    public static AdminModel getParticipantModel(String userId) {
        Gson gson = new Gson();
        AdminModel model = gson.fromJson(preferenceGetter(userId), AdminModel.class);
        return model;
    }


    public static void setUserModel(AdminModel model) {
...
//
    public static AdminModel getUserModel() {
        Gson gson = new Gson();
        AdminModel model = gson.fromJson(preferenceGetter("UserModel"), AdminModel.class);
        return model;
    }
